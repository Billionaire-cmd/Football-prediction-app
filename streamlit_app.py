...
home_expected_goals = st.sidebar.number_input("Home Team Expected Goals (XG)", value=1.02, step=0.01)
away_expected_goals = st.sidebar.number_input("Away Team Expected Goals (XG)", value=1.35, step=0.01)
